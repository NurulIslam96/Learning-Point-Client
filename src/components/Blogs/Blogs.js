...
const Blogs = () => {
  return (
    <div className="container mx-auto gap-4 mt-5 md:grid grid-cols-3">
      ...
      <div className="col-span-1 border rounded-md border-gray-400 bg-white m-2 md:m-0 p-4 flex flex-col justify-between">
        <div className="mb-8">
          ...
          <p className="text-gray-700 text-base">
            ...
            frontend and backend. Node.js basically works on two concept.
            ...
            files, databases.Asynchronous is executing a callback function. The
